...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">Sunrise Hotels</a>
    ...
    <div class="navbar-nav">
        <div class="nav-item text-nowrap">
            <a class="nav-link text-white px-3" href="{{route('logout')}}">Sign Out</a>
        </div>
    </div>
</header>
<div class="container-fluid">
    <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse" style="background-color:#faad06;">
            <div class="position-sticky pt-3 sidebar-sticky">
                <ul class="nav flex-column">
                    <li class="nav-item ">
                        <a class="nav-link text-black {{Request::segment(1) == 'dashboard' ? 'active' : ''}}" style="font-size:17px"
                    ...
                    <li class="nav-itme">
                        <a class="nav-link text-black {{Request::segment(1) == 'booking' ? 'active' : '' }}" style="font-size:17px"
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-black {{Request::segment(1) == 'webpage' ? 'active' : ''}}" style="font-size:17px"
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-black {{Request::segment(1) == 'user' ? 'active' : ''}}" style="font-size:17px"
                            href="{{route('user')}}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <h6
                    ...
                    <span class="text-black" style="font-size:17px">Setting</span>
                </h6>
                <ul class="nav flex-column-mb-2">
                    <li class="nav-item">
                        <a class="nav-link text-black {{Request::segment(1) == 'profile' ? 'active' : ''}}" style="font-size:17px"
